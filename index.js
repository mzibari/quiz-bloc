...
function renderProgress(){
    $(".mobile").text(`Q: ${STORE.currentQuestion}/10 S: ${STORE.correct}/10`);
    $(".tablet").text(`Question: ${STORE.currentQuestion}/10 Score: ${STORE.correct}/10`);
    $(".desktop").text(`Question: ${STORE.currentQuestion}/10 Score: ${STORE.correct} correct ${STORE.incorrect} incorrect`);
}
